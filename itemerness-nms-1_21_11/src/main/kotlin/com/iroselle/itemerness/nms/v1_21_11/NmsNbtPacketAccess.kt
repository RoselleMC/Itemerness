...
/** Exact 1.21.11 access to the non-public block-entity entries embedded in a chunk packet. */
internal object NmsChunkPacketAccess {
    ...
    fun verifyAbi() {
        ...
        check(
            !Modifier.isPublic(blockEntityInfoClass.modifiers) &&
                !Modifier.isProtected(blockEntityInfoClass.modifiers) &&
                !Modifier.isPrivate(blockEntityInfoClass.modifiers)
        ) {
            "ClientboundLevelChunkPacketData.BlockEntityInfo visibility changed"
        }
