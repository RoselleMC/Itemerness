...
/** Projects canonical items anywhere in the exact 26.1.1 ItemStack codec graph. */
internal class NmsRecursiveItemProjector(
    ...
    /** Projects only the exact 26.1.1 component types whose codec graph can contain NBT or text. */
...
/**
 * Exact 26.1.1 item component carrier inventory.
 *
...
/** Exact 26.1.1 accessors needed to preserve otherwise hidden nested component state. */
