...
internal data class NmsProjectionLimits(
    ...
    val recipeComponentNodes: Int,
    val payloadNodes: Int,
    val recipePayloadNodes: Int,
    val itemDepth: Int,
    val items: Int,
    val recipeItems: Int,
    ...
    companion object {
        val DEFAULT = NmsProjectionLimits(
            ...
            recipeComponentNodes = 65_536,
            payloadNodes = 8_192,
            // Bulk recipe envelopes have many small leaves; other carriers keep their own cap.
            recipePayloadNodes = 65_536,
            itemDepth = 16,
            items = 256,
            recipeItems = 8_192,
        ...
        val CANONICAL_FALLBACK = NmsProjectionLimits(
            ...
            recipeComponentNodes = 262_144,
            payloadNodes = 262_144,
            recipePayloadNodes = 262_144,
            itemDepth = 128,
            items = 8_192,
            recipeItems = 8_192,
