...
/** Projects canonical items anywhere in the exact 26.2 ItemStack codec graph. */
internal class NmsRecursiveItemProjector(
    ...
    /** Projects only the exact 26.2 component types whose codec graph can contain NBT or text. */
...
/**
 * Exact 26.2 item component carrier inventory.
 *
...
internal object NmsItemComponentCarriers {
    ...
    val CODEC_GRAPH: List<Carrier> = listOf(
        ...
        Carrier("minecraft:sulfur_cube_content", DataComponents.SULFUR_CUBE_CONTENT, "item-stack-template"),
...
/** Exact 26.2 accessors needed to preserve otherwise hidden nested component state. */
