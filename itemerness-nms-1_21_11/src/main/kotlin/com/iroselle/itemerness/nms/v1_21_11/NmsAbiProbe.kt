...
internal object NmsAbiProbe {
    ...
    fun verify() {
        ...
        ItemStack::class.java.getMethod("getItemHolder")
        ItemStack::class.java.getMethod("getComponentsPatch")
        ItemStack::class.java.getMethod("hasNonDefault", DataComponentType::class.java)
        ...
        BundleContents::class.java.getMethod("weight")
        BundleContents::class.java.getMethod("getSelectedItem")
        ItemContainerContents::class.java.getMethod("stream")
        ChargedProjectiles::class.java.getMethod("of", List::class.java)
        ChargedProjectiles::class.java.getMethod("getItems")
        UseRemainder::class.java.getConstructor(ItemStack::class.java)
        ...
        ItemParticleOption::class.java.getConstructor(ParticleType::class.java, ItemStack::class.java)
        HoverEvent.ShowItem::class.java.getConstructor(ItemStack::class.java)
        ...
        listOf("getNbtPath", "isInterpreting", "getSeparator", "getDataSource")
            .forEach { name -> NbtContents::class.java.getMethod(name) }
        ObjectContents::class.java.getMethod("contents")
